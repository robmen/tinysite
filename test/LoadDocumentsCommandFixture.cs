...
namespace RobMensching.TinySite.Test
{
    public class LoadDocumentCommandFixture
    {
        ...
        public void CanLoadOrderedDocuments()
        {
            ...
            Assert.Equal("parent", documents[0].GetOrDefault<string>("title"));
            Assert.Equal("parent.txt", documents[0].OutputRelativePath);

            Assert.Equal(1, documents[1].Order);
            Assert.Equal("First Ordered Document", documents[1].GetOrDefault<string>("title"));
            ...
            Assert.Equal("Sub-Second Document", documents[2].GetOrDefault<string>("title"));
            ...
            Assert.Equal("Second Document", documents[3].GetOrDefault<string>("title"));
            ...
            Assert.Equal("Another Sub-Second Document", documents[4].GetOrDefault<string>("title"));
            ...
            Assert.Equal("Third Document From Metadata", documents[5].GetOrDefault<string>("title"));
